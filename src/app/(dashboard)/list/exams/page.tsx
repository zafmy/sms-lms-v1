  ...
  return (
    <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
      ...
      <div className="flex items-center justify-between">
        <h1 className="hidden md:block text-lg font-semibold">{t("exams.pageTitle")}</h1>
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          <TableSearch />
          <div className="flex items-center gap-4 self-end">
            <ListFilter paramKey="classId" label={t("common.class")} options={classOptions} />
            <ListFilter paramKey="subjectId" label={t("common.subject")} options={subjectOptions} />
            ...
            {(role === "admin" || role === "teacher") && <ExportButton table="exams" />}
            {(role === "admin" || role === "teacher") && (
